...
type HospitalSummary = chatbot.HospitalSummary
...
const (
	IntentUnknown                       = chatbot.IntentUnknown
	...
	IntentListSpecializationsByHospital = chatbot.IntentListSpecializationsByHospital
